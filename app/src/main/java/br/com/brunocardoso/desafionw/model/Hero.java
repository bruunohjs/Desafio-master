...
public class Hero implements Serializable{
    ...
    public Hero(Integer id, Integer classId, String name, Double healthPoints, Double defense, Double damage, Double attackSpeed, Double movimentSpeed, String className, List<Specialty> specialties, List<String> photos) {
        this.id = id;
